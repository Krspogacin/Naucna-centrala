...
@Service
@Slf4j
public class MailReviewers implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        for (String reviewer: reviewers) {
            User user = this.userService.findByUsername(reviewer);
            if (user == null) {
                throw new NotFoundException("User with username: " + reviewer + " not found");
            }
    ...
    public void sendRegistrationNotification(final String username, final String email, final ScientificWork scientificWork) throws MailException, MessagingException {
        ...
        try {
            ...
            helper.setSubject("Naučna centrala - potrebno je obaviti recenziju!");
            final String message = "Pozdrav " + username + ",<br><br>"
                    + "Obaveštavamo te da ti je dodeljeno da obaviš recenziju rada: "
                    + "<br><br>"
